                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('payrolls.update', $payroll->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            @enderror"
                                value="{{ old('salary', $payroll->salary) }}" name="salary" id="salary">
                            @error('salary')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            @enderror"
                                value="{{ $payroll->bonuses }}" name="bonuses" id="bonuses">
                            @error('bonuses')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            @enderror"
                                value="{{ $payroll->deductions }}" name="deductions" id="deductions">
                            @error('deductions')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text"
                                class="form-control @error('net_salary') is-invalid
                            @enderror"
                                value="{{ old('net_salary'), $payroll->net_salary }}" name="net_salary" id="net_salary"
                                readonly>
                            @error('net_salary')
                                <div class="invalid-feedback">
                                    {{ $message }}
                        ...
                        <div class="mb-3">
                            ...
                            @enderror"
                                value="{{ $payroll->pay_date }}" name="date" required>
                            @error('pay_date')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
