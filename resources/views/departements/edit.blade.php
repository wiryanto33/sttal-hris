                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('departements.update', $departement->id) }}" method="POST">
                        ...
                        <div class="mb-b">
                            ...
                            <input type="text" class="form-control" name="name" value="{{ old('name', $departement->name) }}" required>
                            @error('name')
                        ...
                        <div class="mb-b">
                            ...
                            @enderror">
                                {{ old('description', $departement->description) }}
                            </textarea>
                            @error('description')
                                <div class="invalid-feedback">
                                    {{ $message }}
                        ...
                        <div class="mb-3">
                            ...
                            @enderror">
                                <option value="inactive" @if (old('status', $departement->status) == 'inactive') selected @endif>Inactive</option>
