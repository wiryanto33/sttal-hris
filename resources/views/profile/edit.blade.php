                        ...
                        <div class="card-body">
                            <form action="{{ route('password.update') }}" method="POST">
                                ...
                                @if (session('status') === 'password-updated')
                                    <div class="alert alert-success mt-2">Password updated.</div>
                                @endif
                            </form>
                        </div>
                    </div>
                            ...
                            <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="pangkat" id="pangkat" class="form-control"
                                        placeholder="Pangkat" value="{{ old('pangkat', $user->userDetail?->pangkat) }}">
                                    @error('pangkat')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="korps" id="korps" class="form-control"
                                        placeholder="Corps" value="{{ old('korps', $user->userDetail?->korps) }}">
                                    @error('korps')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nrp" id="nrp" class="form-control"
                                        placeholder="Nrp" value="{{ old('nrp', $user->userDetail?->nrp) }}">
                                    @error('nrp')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="address" id="address" class="form-control @error('address') is-invalid @enderror">{{ old('address', $user->userDetail?->address) }}</textarea>
                                    @error('address')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date"
                                        ...
                                        value="{{ old('birth_date', $user->userDetail?->birth_date) }}" name="birth_date"
                                        id="birth_date">
                                    @error('birth_date')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date"
                                        ...
                                        value="{{ old('join_date', $user->userDetail?->join_date) }}" name="join_date"
                                        id="join_date">
                                    @error('join_date')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="status" id="status"
                                            ...
                                            <option value="inactive"
                                                @if (old('status', $user->userDetail?->status) == 'inactive') selected @endif>Inactive
                                            </option>
                                            <option value="active"
                                                @if (old('status', $user->userDetail?->status) == 'active') selected @endif>Active
                                            </option>
                                        </select>
                                        @error('status')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                @else
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="{{ $user->userDetail?->status ?? '-' }}" readonly>
                                    </div>
                                @endif
